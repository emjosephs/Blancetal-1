...
```{r}
##pick a sample of 'nots' that are high expression
summary(dnot$expr)
summary(dsig$expr)

## pick the top  expressed genes in dnot (there are 888 sig genes)
dnot_high = dnot[order(-dnot$expr),][1:3000,]
summary(dnot_high$expr)

##do the test with only things that have leaf expression
